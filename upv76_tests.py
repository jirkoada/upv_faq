...
if __name__ == "__main__":
    ...
    faq = FAQ(model, "data/FAQ76_questions.csv", "data/FAQ76_answers.csv", probs=probs, alpha=args.alpha, compressed=args.compressed)
    ...
    if args.save:
        save_dir = args.model_path.replace(".bin", f"_STS76_alpha={args.alpha}")
