...
faq = [
    ...
    'Kdo může pomoci s přihlašováním vynálezu, užitného vzoru, průmyslového vzoru nebo ochranné známky?',
    'Co je to vymáhání práv z průmyslového vlastnictví?',
    'Může Úřad průmyslového vlastnictví pomoci při prosazování práv? Případně jak?',
    'Kam se lze ještě obrátit v případě porušení práv z duševního vlastnictví?', 
    'Jaká je lhůta pro podání námitek? Lze tuto lhůtu prodloužit?', 
    'Kdo může podat námitky?', 
    'Lze podané námitky později doplnit novými důkazy nebo rozšířit jejich odůvodnění?', 
    'Obdrželi jsme námitky k vyjádření. Co máme dělat?', 
    'Co je to „ochranná známka s dobrým jménem“ a „všeobecně známá známka“?', 
    'Co znamená místní dosah nezapsaného či jiného označení?', 
    'Jaké jsou oprávněné osoby k podání připomínek?', 
    'Jaká je lhůta k podání připomínek?', 
    'Jaký je správní poplatek za podání námitek a jaký za podání připomínek?', 
    'Jak podat námitky nebo připomínky? Existuje formulář?', 
    'Pokud už byla ochranná známka zaregistrována, mohu se nějak domoci jejího výmazu?', 
    'Jaký je rozdíl mezi zrušením ochranné známky a prohlášením ochranné známky za neplatnou?', 
    'Co se rozumí pod pojmem „řádné užívání ochranné známky“?', 
    'Jaké informace poskytují patentové knihovny?', 
    'Jakým způsobem lze získat rešerši?', 
    'Je možné na Internetu zjistit, zda je určité označení chráněné jako ochranná známka?', 
    'Co obsahuje národní známková databáze a jak často je aktualizována?', 
    'Jak lze získat informace o aktuálním právním stavu patentů, ochranných známek, průmyslových vzorů, užitných vzorů a označení původu/zeměpisných označení?', 
    'Jak lze provést rešerši v databázi ochranných známek na našem webu?', 
    'Jaký má pro firmu přínos provedení průmyslověprávní rešerše?', 
    'Obnova ochranné známky',
    'Kde najdu formulář k přihlašování ochranné známky',
    'Jakým způsobem se zatřiďují výrobky a služby, které je nutné uvést v přihlášce ochranné známky k zápisu do rejstříku ochranných známek?', 
    'Musím u své ochranné známky uvádět ®? Co znamenají symboly: TM a ©?', 
    'Jak se provádí oceňování průmyslových práv?', 
    'Jak Úřad podává informaci o zahájení řízení o zápisu převodu ochranné známky, patentu, průmyslového vzoru či užitného vzoru?', 
    'Jakou formu mají mít doklady přikládané k žádostem o zápis převodu, licence a zástavy?', 
    'Co je to prezidiální plná moc, jakým způsobem je evidována u Úřadu, jaké jsou její náležitosti?', 
    'Za jakých podmínek lze nahlížet do správního spisu?', 
    'Jak postupovat při placení udržovacích poplatků u patentů, resp. požádat o obnovu, prodloužení platnosti u ochranných známek, užitných vzorů a průmyslových vzorů?', 
    'Kdo může požádat o výpis z rejstříku?', 
    'Komu může být vydán opis listiny vydané Úřadem?', 
    'Jakým způsobem je možné získat doklad do účetnictví o zaplacení za přihlášku vynálezu, popř. za uhrazení udržovacích poplatků?', 
]
...
ans = [
    ...
    '''Námitky musí splňovat náležitosti dané ustanovením § 25 zákona č. 441/2003 Sb. a ustanovení § 3 vyhlášky č. 97/2004 Sb., k provedení zákona o ochranných známkách. Námitky včetně důkazů se podávají ve dvojím vyhotovení a obsahují:
    ...
    podpis.
    Podání připomínek je upraveno ustanovením § 24 zákona č. 441/2003 Sb. a ustanovením § 2 vyhlášky č. 97/2004 Sb., k provedení zákona o ochranných známkách. Připomínky k přihlášce ochranné známky obsahují:
    ...
    Správní poplatky je možné uhradit převodem z účtu na účet Úřadu (3711-21526001/0710), složenkou nebo v hotovosti v pokladně Úřadu. Kolkovými známkami lze uhradit správní poplatek jen do výše 5.000,- Kč.''' , 
    ...
    identifikace zmocnitele (např. jméno, příjmení nebo obchodní firma, adresa zmocnitele),
    identifikace zástupce/zmocněnce (např. jméno, příjmení, adresa zástupce),
    zmocnění,
    datum a podpis. ''' , 
    ...
    '''Poplatky za udržování patentů a evropských patentů se platí bez podání žádosti, pouze uhrazením těchto poplatků s uvedením variabilního symbolu (číslo patentu).
    Udržovací poplatky nelze platit kolkovými známkami. Plátcem je majitel patentu nebo jeho zástupce.
...
bench = {
    "questions" : [
        'Co je to duševní vlastnictví?' , 'Jaký je význam výrazu "duševní vlastnictví"?' , 'Jaký je přesný smysl pojmu "duševní vlastnictví"?' , 
        
        'Jaké existují možnosti ochrany předmětů technického charakteru?' , 'Jaká je dostupná cesta ke zajištění technických věcí?' , 'Jaký je nejlepší způsob, jak udržet a zajistit technické věci?' , 'Jaký je nejlepší postup k udržení a zajištění technických věcí?' ,
        
        'Kdo může pomoci s přihlašováním vynálezu, užitného vzoru, průmyslového vzoru nebo ochranné známky?' , 'Kdo je schopen poskytnout pomoc s registrací vynálezu, užitečného vzoru, průmyslového designu nebo ochranného označení?' , ' Kdo může pomoci s procesem zapisování vynálezu, užitečných forem, průmyslových vzhledů nebo ochranných značek?' ,
        
        'Co je to vymáhání práv z průmyslového vlastnictví?' , 'Jaký je smysl uplatňování práv z průmyslového vlastnictví?' , 'Co je cílem implementace práv z průmyslového vlastnictví?' ,
        
        'Může Úřad průmyslového vlastnictví pomoci při prosazování práv? Případně jak?' , 'Je možné, aby Úřad průmyslového vlastnictví pomohl se zajištěním práv?' , ' Pokud ano, jakou formou? ' , 'Může Úřad průmyslového vlastnictví poskytnout pomoc při zajištění práv? Pokud ano, jakou formou to bude probíhat?' ,
        
        'Kam se lze ještě obrátit v případě porušení práv z duševního vlastnictví?' , 'Pokud je porušeno právo duševního vlastnictví, na koho se může dotčená osoba obrátit?' , 'Existuje možnost na koho se obrátit pro ty, kteří jsou postiženi porušením práva z duševního vlastnictví?' ,
        
        'Jaká je lhůta pro podání námitek?' , 'Lze tuto lhůtu prodloužit? Kolik času mám na to, abych něco namítl?' , 'Je možné si prodloužit tento časovou lhůtu?' , 'Mám nějakou dobu na to, abych něco namítl? Existuje možnost prodlužit tuto časovou lhůtu?' ,
        
        'Kdo může podat námitky?' , 'Kdo má právo vznést námitky?' , 'Kdo je oprávněn předložit odpor?' ,
        
        'Lze podané námitky později doplnit novými důkazy nebo rozšířit jejich odůvodnění?' , 'Je možné později doplnit předložené námitky dokumentací nebo je rozšířit o vysvětlení?' , 'Je možné navíc k předloženým námitkám k dokumentaci přidat ještě další informace nebo doplnit je o vysvětlení?' ,
        
        'Obdrželi jsme námitky k vyjádření. Co máme dělat?' , 'Dostali jsme odpovědi, které se týkají našeho vyjádření. Jak máme postupovat?' , 'Získali jsme odpovědi, které se vztahují k našemu prohlášení. Jak máme pokračovat?' ,
        
        'Co je to „ochranná známka s dobrým jménem“ a „všeobecně známá známka“?' , 'Jaký má význam "ochranná známka s dobrým jménem" a "obecně známá známka"?' , 'Jaký má smysl pojem "ochranná známka s dobrým jménem" a "všeobecně známá známka"?' ,
        
        'Co znamená místní dosah nezapsaného či jiného označení?' , 'Jaký je vliv neregistrovaného nebo jiného označení na okolní oblast?' , 'Jaká může být dopat v místním dosahu na nezapsaného nebo různého označení?' ,
        
        'Jaké jsou oprávněné osoby k podání připomínek?' , 'Kdo všechno může být oprávněná osoba, která podává připomínky?' , 'Jaké osoby mají právo podat připomínky?' ,
        
        'Jaká je lhůta k podání připomínek?' , 'Jaký je časový limit k podání připomínek?' , 'Kdy je poslední možnost zaslat své připomínky?' ,
        
        'Jaký je správní poplatek za podání námitek a jaký za podání připomínek?' , 'Jaká je výše správní úhrady, kterou je třeba zaplatit za podání námitek a jaká za podání připomínkek?' , 'Jaká je správní taxa za podání námitek, zároveň i za podání připomínek?' ,
        
        'Jak podat námitky nebo připomínky? Existuje formulář?' , 'Jakým způsobem můžeme podat námitky nebo připomínky?Kde nalezneme požadovaný formulář?' , 'Jaké jsou možnosti  podání námitek nebo připomínek?Kde nelazneme vhodný tiskopis?' ,
        
        'Pokud už byla ochranná známka zaregistrována, mohu se nějak domoci jejího výmazu?' , 'Když byla ochranná známka zapsána, jak mohu její registraci zrušit?' , 'Jakmile proběhlo zaregistrování ochranné známky, jak vypadá způsob jejího smazání?' ,
        
        'Jaký je rozdíl mezi zrušením ochranné známky a prohlášením ochranné známky za neplatnou?' , 'Jak se od sebe líší způsob zrušení ochranné známky a prohlášením ochranné známky za neplatnou?' ,  'Jak se liší procesy ukončení platnosti ochranné známky a prohlášení ochranné známky za neplatnou?' ,
        
        'Co se rozumí pod pojmem „řádné užívání ochranné známky“?' , ' Jaký je význam fráze „řádné užívání ochranné známky“?' , 'Co to znamená, když se mluví o „řádném užívání ochranné známky“?' ,
        
        'Jaké informace poskytují patentové knihovny?' , 'Patentové knihovny nabízejí jaké informace?' , 'Jaká užitečná data nalezneme v patentové knihovně?' , 'Jaká informativní sdělení můžeme objevit v patentové knihovně?' ,
        
        'Jakým způsobem lze získat rešerši?' , 'Jaký je nejlepší postup pro získání rešerši?' , 'Která metoda je nejvhodnější pro dosažení informací?' ,
        
        'Je možné na Internetu zjistit, zda je určité označení chráněné jako ochranná známka?' , 'Lze se dozvědět, zda je nějaké označení chráněno jako ochranná známka na Internetu?' , 'Je možné zjistit, jestli existuje nějaká identifikace, která je chráněna jako ochraná známka na webu?' ,
        
        'Co obsahuje národní známková databáze a jak často je aktualizována?' , 'Jaké informace obsahuje národní známková databáze a jak často je obnovovuje?' , 'Co se dá vyčíst z národní databáze známek a jak často se aktualizuje?' ,
        
        'Jak lze získat informace o aktuálním právním stavu patentů, ochranných známek, průmyslových vzorů, užitných vzorů a označení původu/zeměpisných označení?' , 'Jak se dostat k informacím o současném právním postavení patentů, ochranných známek, průmyslových vzorů, užitných vzorů a označení původu/zeměpisných označení?' , 'Kde mám hledat informace o aktuálním stavu patentů, ochranných známek, průmyslových vzorů, užitných vzorů a označení původu/zemepisných označení?' ,
        
        'Jak lze provést rešerši v databázi ochranných známek na našem webu?' , 'Provedení vyhledávání dat v databázi ochranných známek na našich webových stránkách?' , 'Jakým způsobem se dostanu k postupu "realizace rešerše v databázi ochranných známek na našem webu?' , 'Jak vyhledám postup realizace rešerše v databázi ochranných známek na našich webových stránkách?' ,
        
        'Jaký má pro firmu přínos provedení průmyslověprávní rešerše?' , 'Jaká je pro společnost výhoda zrealizování průmyslového právního výzkumu?' , 'Co získá firma provedením průmyslověprávní rešerší?' ,
        
        'Obnova ochranné známky.' , 'Znovuvytvoření ochranné známky.' , 'Znovuzřízení ochranné známky', 
        
        'Kde najdu formulář k přihlašování ochranné známky?' , 'Kde si mohu stáhnout dokument pro podání žádosti o ochrannou známku?' , 'Jak získat formulář, který by mi umožnil podat žádost o ochrannou známku?' ,
        
        'Jakým způsobem se zatřiďují výrobky a služby, které je nutné uvést v přihlášce ochranné známky k zápisu do rejstříku ochranných známek?' , 'Jakým systémem se zakládají výrobky a služby, které je nutné uvést v přihlášce ochranné známky k zápisu do rejstříku ochranných známek?' , 'Jakým stylem se zařazují výrobky a služby, které je nutné uvést v přihlášce ochranné známky k zápisu do rejstříku ochranných známek?' ,
        
        'Musím u své ochranné známky uvádět ®?' , 'Co znamenají symboly: TM a ©?' , 'Je potřeba u své ochranné známky zmiňovat ®?' , 'Co znamenají znaky: TM a ©?' , 'Měl bych u své ochranné známky hlásit ®?' , 'Jaký mají smysl symboly : TM a ©?' , 
        
        'Jak se provádí oceňování průmyslových práv?' , 'Jak se provádí oceňování průmyslových práv?' ,
        
        'Jak Úřad podává informaci o zahájení řízení o zápisu převodu ochranné známky, patentu, průmyslového vzoru či užitného vzoru?' , 'Jak se Úřad oficiálně rozhoduje ohledně toho, aby byl zapsán převod ochranné známky, patentu, průmyslového či užitného vzoru?' , 'Jak Úřad sděluje informaci o započatém řízení o zápisu převodu ochranné známky, patentu, průmyslového vzoru či užitného vzoru?' ,
        
        'Jakou formu mají mít doklady přikládané k žádostem o zápis převodu, licence a zástavy?' , 'Jak by měl vypadat vzhled dokladů přiložených k žádostem o zápisu převodu, licence a zástavy?' , 'Které dokumenty musí být přiloženy k žádostem o vložení převodu, licence a zástavy do veřejného seznamu?' , 'Jak by měly vypadat  doklady přikládané k žádostem o zápis převodu, licence a zástavy?', 
        
        'Co je to prezidiální plná moc, jakým způsobem je evidována u Úřadu, jaké jsou její náležitosti?' , 'Jaký má význam prezidiální plná moc a jak je u Úřadu zaznamenána?' , 'Jaké jsou její specifické rysy?' , 'Jak vypadá prezidiální plná moc, jak se zpracovává u Úřadu, jaká jsou její kritéria?' ,
        
        'Za jakých podmínek lze nahlížet do správního spisu?' , 'Existují nějaké požadavky, které je třeba splnit, aby bylo možné získat přístup do správního spisu?' , 'Jaké jsou podmínky k náhlednutí do správního spisu?' , 'Jaká opatření musíme splnit, abychom mohli nahlídnout do správního spisu?' ,
        ...
        'Kdo může požádat o výpis z rejstříku?' , 'Kdo si může vyžádat výpis z rejstříku?' , 'Komu se může vydat vypis z rejstříku na požádání?' ,
        
        'Komu může být vydán opis listiny vydané Úřadem?' , 'Kdo má právo dostat kopii dokumentu vystaveného Úřadem?' , 'Komu může Úřad poskytnout vydaný opis listiny?' ,
    ],
    "ids" : [
            0, 0, 0, 
            1, 1, 1, 1, 
...
if __name__ == "__main__":
    ...
    oof = ''''Co je to duševní vlastnictví?' , 'Jaký je význam výrazu "duševní vlastnictví"?' , 'Jaký je přesný smysl pojmu "duševní vlastnictví"?' , 
    ...
    brf = oof.split("\n        \n")
    for i, s in enumerate(brf):
        commaCount = 0
        for char in s:
            if char == "'":
                commaCount+=1
        for j in range(int(commaCount / 2)):
            print(f"{i}, ", end='')
        print("")
