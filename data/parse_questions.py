...
if __name__ == "__main__":
    df = pd.read_excel("FAQ50_raw2.xlsx")
    ...
    q_data.to_excel("FAQ50_questions.xlsx")
    a_data.to_excel("FAQ50_answers.xlsx")
    q_data.to_csv("FAQ50_questions.csv", sep="\t")
    a_data.to_csv("FAQ50_answers.csv", sep="\t")
